...
export async function TestValidObject3() {
...
export  function ValidateMissingFields() {
    let testSubject : IRootObject= JSON.parse(testObject2);
    testSubject.request = null
    assert.equal(false, TemplateValidator.ValidateContent(testSubject),
        "should be false here");
} 

export  function ValidateMissingFields2() {
    let testSubject: IRootObject = JSON.parse(testObject2);
...
export  function ValidateMissingFields3() {
    let testSubject: IRootObject = JSON.parse(testObject2);
...
export  function ValidateMissingFields4() {
    let testSubject: IRootObject = JSON.parse(testObject);
    testSubject.kind = null;
    assert.equal(false, TemplateValidator.ValidateContent(testSubject),
        "should be false here");
}

export  function ValidateMissingFields5() {
    let testSubject: IRootObject = JSON.parse(testObject2);
...
export function ValidateMissingFields6() {
    let testSubject: IRootObject = JSON.parse(testObject2);
...
export function ValidateMissingFields7() {
    let testSubject: IRootObject = JSON.parse(testObject2);
...
export function DiffCalculatorNull1() {
    assert.equal(null, DiffCalculator.CalculateDiff(null,null),
        "should be null here");
}

export function DiffCalculatorNull2() {
    let testSubject: IRootObject = JSON.parse(testObject);
    let result = DiffCalculator.CalculateDiff(testSubject, null);
...
export function DiffCalculatorTestContent() {
    let testSubject: IRootObject = JSON.parse(testObject);
    let result = DiffCalculator.CalculateDiff(testSubject, null);
